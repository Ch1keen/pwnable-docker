...
RUN	apt -y update
RUN	apt install -y vim python python-dev gdb wget curl gcc make git libc6:i386 libncurses5:i386 libstdc++6:i386 ca-certificates patch pkg-config strace ltrace file upx-ucl netcat ruby-full --no-install-recommends
